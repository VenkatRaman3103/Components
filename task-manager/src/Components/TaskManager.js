      ...
      <div className="current-week-section">
        {currentWeek.map((date, index) => (
          ...
          >
            ...
            <div className={`date-label ${isToday(date) ? "highlight" : ""}`}>
                ...
                <div className="task-preview-section">
                  ...
                  <div className="task-overview-wrapper">
                    ...
                    <div className="task-name">
                      {index + 1} {item.title} - {item.task.type}
                    </div>
                  </div>
                </div>
                    ...
                    <div className="meeting-section-container">
                      ...
                      <div className="meeting-notes-wrapper">
                        ...
                        <div className="notes-list-wrapper-meeting">
                          <ul>
                            {item.task.tasks[0]?.notes?.map((point, idx) => (
                              <li key={idx}>{point}</li>
                            ))}
                          </ul>
                        </div>
              ...
              <div className="task-overview-wrapper">
                ...
                <div className="task-timing-wrapper">
                  <div className="task-timing">
                    <span>12:30 PM</span> <LongArrowMark />{" "}
                    <span>01:00 PM</span>
                  </div>
                </div>
              </div>
          ...
          <div className={`members-list ${isAddMemberActive ? "show" : ""}`}>
            <div className="members-list-wrapper">
              <div className="add-member-header">
                <div className="header-text">select the members</div>
                <div
                  className="close-btn"
                ...
                return (
                  <div className="member-wrapper" key={index}>
                    ...
                    <button
                      ...
                      onClick={() =>
                        isMemberAdded ? removeMember(member) : addMember(member)
                      }
                    >
